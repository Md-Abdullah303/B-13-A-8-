...
const QurbaniTips = () => {
  return (
    <div className=" bg-blue-100">
      <div className="w-[90%] md:container mx-auto py-20 px-3 md:px-10 space-y-4 ">
        <h1 className="text-xl md:text-3xl font-bold">Qurbani Tips</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col md:flex-row md:items-start items-center gap-2.5 text-gray-500 border border-gray-300 p-5 rounded-lg shadow-sm duration-200 hover:-translate-y-2 cursor-pointer">
